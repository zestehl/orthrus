...
logger = logging.getLogger("orthrus.ml_data")
...
class MLDataExporter:
    ...
    def __init__(self, output_dir: Optional[Path] = None):
        self.output_dir = output_dir or Path.home() / ".hermes" / "orthrus" / "ml_data"
    ...
    def export_detection_trajectory(
        ...
        filename = f"orthrus_{safe_type}_{ts}.json"
    ...
    def _build_trajectory(
        ...
        orthrus_alert = self._format_alert(entropy_type, severity, detection_details)
        ...
        trajectory = [
            ...
            {"from": "system", "value": orthrus_alert},
