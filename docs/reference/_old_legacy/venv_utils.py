...
def get_orthrus_venv_paths() -> List[str]:
...
def build_orthrus_subprocess_env(
    ...
    argus_paths = get_orthrus_venv_paths()
...
def resolve_venv_python(python_cmd: Optional[str] = None) -> str:
    ...
    env = build_orthrus_subprocess_env()
