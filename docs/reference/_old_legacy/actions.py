...
logger = logging.getLogger("orthrus.actions")
...
def _get_cron_env() -> Dict[str, str]:
    ...
    """
    return _venv_utils.build_orthrus_subprocess_env()
...
def safe_subprocess(
    ...
    Side effects: Logs warnings/errors via orthrus.actions logger.
    """
    try:
...
def terminate_pid(pid: Union[str, int], context: str = "terminate") -> None:
    ...
    Side effects:
        ...
        - Logs info via orthrus.actions logger
...
def restart_cron_session(session: Dict, corrective_prompt: str) -> None:
    ...
    Side effects:
        ...
        - Logs info/warning/error via orthrus.actions logger
...
def kill_session(
    ...
    Side effects:
        ...
        - Commits connection
        - Logs info/error via orthrus.actions logger
