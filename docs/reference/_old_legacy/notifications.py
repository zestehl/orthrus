...
logger = logging.getLogger("orthrus.notifications")
...
def send_to_all_platforms(message: str, prefer_gateway: bool = False) -> Dict[str, Tuple[bool, Optional[str]]]:
    ...
    Side effects:
        ...
        - Logs info/warning/error via orthrus.notifications logger
...
def send_notification(
    ...
    Side effects:
        ...
        - Commits connection
        - Logs info/warning via orthrus.notifications logger
